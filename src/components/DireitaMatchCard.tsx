...
import logo from "@/assets/direita-match-logo.webp";
...
export const DireitaMatchCard = () => {
  return (
    <article className="card-soft p-6 sm:p-7 flex flex-col h-full transition-transform hover:-translate-y-0.5">
      ...
      <a
        href={addUTMParams("https://app.direitamatch.com.br/login", {
          source: "site",
          medium: "portfolio",
          campaign: "direita_match",
        })}
        target="_blank"
      ...
      <a
        href={addUTMParams("https://www.direitamatch.com.br/", {
          source: "site",
          medium: "portfolio",
          campaign: "direita_match",
        })}
